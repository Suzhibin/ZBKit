...
@interface MenuViewController ()<ZBURLSessionDelegate,UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    if (_functionType==AFNetworking) {
        ...
        [[ZBURLSessionManager sharedInstance]getRequestWithURL:menu_URL target:self apiType:ZBRequestTypeDefault];
    }
    [self.tableView addSubview:self.refreshControl];
    [self.view addSubview:self.tableView];
    
    [self addItemWithTitle:@"缓存设置" selector:@selector(btnClick) location:NO];
...
- (void)btnClick{
    ...
    SettingCacheViewController *settingVC=[[SettingCacheViewController alloc]init];
