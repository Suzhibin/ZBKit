...
@interface ZBCarouselView()<UIScrollViewDelegate>
//轮播的图片数组
...
- (void)downloadImages:(int)index {
    ...
    [[SDWebImageManager sharedManager]loadImageWithURL:[NSURL URLWithString:_imageArray[index]] options:0 progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
