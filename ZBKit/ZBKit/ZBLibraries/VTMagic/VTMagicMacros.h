...
//iOS 13 过期 #define STATUS_HEIGHT  [[UIApplication sharedApplication] statusBarFrame].size.height
#define STATUS_HEIGHT (CGFloat)(KiPhoneX?(44.0):(22.0))
// tabbar高度
#define VTTABBAR_HEIGHT (KiPhoneX ? 83 : 49)
// 状态栏高度
//#define VTSTATUSBAR_HEIGHT (KiPhoneX ? STATUS_HEIGHT : 20)
